...
export type { Body_University_update_assigned_universities } from './models/Body_University_update_assigned_universities';
...
export type { UniversityOwnershipRetrieve } from './models/UniversityOwnershipRetrieve';
